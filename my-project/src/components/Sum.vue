<template>
    <div style="text-align: center">
        ...
        <div style="display:inline-block">
            ...
            <counter v-bind:base-count="100" 
                     v-on:increase-counter="increaseTotal" 
                     v-on:decrease-counter="decreaseTotal">
            </counter>
        </div>
        <div style="display:inline-block">
            <!-- 1. counter 컴포넌트 선언 -->
            <!-- 2. props 속성에 대한 v-bind  -->
            <!-- 3. counter 컴포넌트에서 발신된 이벤트를 v-on: 으로 수신 -->
            <counter :base-count="500" 
                     @increase-counter="increaseTotal" 
...
export default {
    ...
    methods: {
        increaseTotal: function(baseCount) {
            this.total += baseCount;
        },
        decreaseTotal: function(baseCount) {
            this.total -= baseCount;
        }
    }
